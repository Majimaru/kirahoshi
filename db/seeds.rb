...
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 1);
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 12);
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 23);
TagRelationship.find_or_create_by!(post_id: 1, tag_id: 33);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 2);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 3);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 4);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 5);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 6);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 15);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 2, tag_id: 23);
...
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 7);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 27);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 29);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 30);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 33);
TagRelationship.find_or_create_by!(post_id: 3, tag_id: 37);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 6);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 9);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 11);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 12);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 14);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 4, tag_id: 36);
TagRelationship.find_or_create_by!(post_id: 5, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 5, tag_id: 13);
TagRelationship.find_or_create_by!(post_id: 5, tag_id: 14);
TagRelationship.find_or_create_by!(post_id: 5, tag_id: 39);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 2);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 15);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 16);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 17);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 18);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 20);
TagRelationship.find_or_create_by!(post_id: 6, tag_id: 27);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 2);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 6);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 15);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 19);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 20);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 23);
TagRelationship.find_or_create_by!(post_id: 7, tag_id: 36);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 6);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 12);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 22);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 23);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 24);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 33);
TagRelationship.find_or_create_by!(post_id: 8, tag_id: 37);
TagRelationship.find_or_create_by!(post_id: 9, tag_id: 3);
TagRelationship.find_or_create_by!(post_id: 9, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 9, tag_id: 23);
TagRelationship.find_or_create_by!(post_id: 9, tag_id: 25);
TagRelationship.find_or_create_by!(post_id: 9, tag_id: 26);
...
TagRelationship.find_or_create_by!(post_id: 10, tag_id: 28);
TagRelationship.find_or_create_by!(post_id: 10, tag_id: 29);
TagRelationship.find_or_create_by!(post_id: 10, tag_id: 37);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 18);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 27);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 29);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 30);
TagRelationship.find_or_create_by!(post_id: 11, tag_id: 36);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 1);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 3);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 26);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 31);
TagRelationship.find_or_create_by!(post_id: 12, tag_id: 32);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 3);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 6);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 10);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 21);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 23);
TagRelationship.find_or_create_by!(post_id: 13, tag_id: 34);
...
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 8);
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 39);
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 40);
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 41);
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 42);
TagRelationship.find_or_create_by!(post_id: 16, tag_id: 43);
